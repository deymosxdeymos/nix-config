...
hi(0, "Function",      { fg = c.fg, bold = false })
...
hi(0, "DiagnosticWarn",           { fg = "#886600" })
hi(0, "DiagnosticInfo",           { fg = c.subtle })
hi(0, "DiagnosticHint",           { fg = c.muted })
hi(0, "DiagnosticUnderlineError", { undercurl = true, sp = "#cc0000" })
hi(0, "DiagnosticUnderlineWarn",  { undercurl = true, sp = "#886600" })

-- Diff
hi(0, "DiffAdd",    { bg = "#d4f4d4" })
hi(0, "DiffChange", { bg = "#f0f0d4" })
hi(0, "DiffDelete", { bg = "#f4d4d4", fg = c.ghost })
hi(0, "DiffText",   { bg = "#e0e0b0" })
